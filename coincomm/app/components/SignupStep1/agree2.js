      ...
      <div>
        <p className={classes.agreeP}>
          <em className="emphasis">
            &lt;코인놀자&gt;{`('http://www.coinnolja.co.kr'이하 '코인놀자')`}
          </em>
        ...
        <p className={classes.agreeP}>
          <em className="emphasis">&lt;코인놀자&gt;{`('코인놀자')`}</em> 은(는)
        ...
        <p className="lh6 bs4">
          ...
          <br />
          <br />① <em className="emphasis">&lt;코인놀자&gt;{`('코인놀자')`}</em>
        ...
        <p className="lh6 bs4">
          ...
          <br />
          <br /> ①{' '}
          <em className="emphasis">&lt;코인놀자&gt;{`('코인놀자')`}</em>
        ...
        <p className={classes.agreeP}>
          ① 정보주체는 코인놀자에 대해 언제든지 개인정보 열람,정정,삭제,처리정지
          요구 등의 권리를 행사할 수 있습니다.
          <br />② 제1항에 따른 권리 행사는코인놀자에 대해 개인정보 보호법 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 코인놀자은(는) 이에 대해 지체 없이 조치하겠습니다.
          ...
          <br />⑥ 코인놀자은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        ...
        <p className={classes.agreeP}>
          ① 코인놀자 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
        ...
        <br /> ① 코인놀자(‘http://www.coinnolja.co.kr’이하 ‘코인놀자) 은(는)
        ...
        <p className={classes.agreeP}>
          ...
          직급 :개발팀장
          <br />
          연락처 :01030982101, dev.coinnolja@gmail.com, <br />※ 개인정보 보호
          담당부서로 연결됩니다.
          <br /> <br />▶ 개인정보 보호 담당부서
          <br />
          부서명 :<br />
          담당자 :<br />
          연락처 :, , <br />② 정보주체께서는
          코인놀자(‘http://www.coinnolja.co.kr’이하 ‘코인놀자) 의 서비스(또는
          사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
          피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실
          수 있습니다. 코인놀자(‘http://www.coinnolja.co.kr’이하 ‘코인놀자)
        ...
        <p className={classes.agreeP}>
          ...
          4. 해킹 등에 대비한 기술적 대책
          <br />
          <em className="emphasis">코인놀자</em>
          {`('코인놀자')`}은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및
